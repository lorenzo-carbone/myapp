...
/**
 * Provides the local service interface for Myapp. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see MyappLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface MyappLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MyappLocalServiceUtil} to access the myapp local service. Add custom service methods to <code>com.liferay.demo.myapp.service.impl.MyappLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public Myapp createMyapp(long myappId);
	...
	public Myapp deleteMyApp(Myapp myApp) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Myapp fetchMyapp(long myappId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Myapp> getMyapps(int start, int end);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Myapp> getMyAppsByGroupId(
